...
$ServersToCreate |%{
    $imageName = 'microsoft/dynamics-nav:devpreview-november-finus'
    $d = $_.Server
    ...
    CreateDevServerContainer -devContainerName $d -dbBackup $bakupPath -devImageName $imageName
